...
domain_data <- All_Site_Split2 %>% select(worriedyourself, worriedothers, worriedphysical, worriedmental, readingtalking)
domain_data<-domain_data[complete.cases(domain_data),]


cfa_model <- 'covid_worries =~ worriedyourself + worriedphysical +worriedothers +  worriedmental' 

cfa_fit <- cfa(cfa_model, data = domain_data,
            ordered=c("worriedyourself","worriedphysical","worriedothers", "worriedmental"))
...
cfa_model_2 = 'factor1 =~ worriedyourself + worriedphysical
factor2 =~ worriedothers 
factor3 =~ worriedmental' 
